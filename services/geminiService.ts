...
import { StudentProfile, CareerRecommendation, ChatMessage, SkillSuggestion } from "../types.ts";
...
/**
 * Helper to clean Markdown code blocks from model responses before parsing JSON.
 */
